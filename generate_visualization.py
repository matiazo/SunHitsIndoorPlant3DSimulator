...
from sun_plant_simulator.core.sun_position import generate_sun_data_for_date, get_sunrise_sunset
...
def main():
    ...
    # Get sunrise/sunset
    sunrise, sunset = get_sunrise_sunset(latitude, longitude, target_date, timezone_offset)
